...
with tab3:
    ...
    if not props.empty:
        ...
        gb2.configure_column("Hold",     aggFunc="first", type=["numericColumn"], cellRenderer=r_num,    width=52)
        gb2.configure_column("CoC %",    aggFunc="first", type=["numericColumn"], cellRenderer=r_pct,    width=68)
